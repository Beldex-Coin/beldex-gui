...
<context>
    ...
    <message>
        ...
        <translation>あなたのコンピュータでマイニングを行うことで、Beldexのネットワークをより強固にすることができます。マイニングをする人が増えるほど、ネットワークへの攻撃が難しくなります。一人一人の協力が大切です。&lt;br&gt; &lt;br&gt;マイニングをすると、低確率ですがBeldexを獲得できる可能性があります。あなたのコンピュータは、ある計算問題の解となるブロックとそのハッシュ値を計算します。正解のブロックが見つかると、あなたはそれに伴う報酬を得ます。グッドラック!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Embedded Beldex version: </source>
        <translation>埋め込まれたBeldexのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはBeldexウォレットおよびBeldexのキーを再利用するBeldexクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Beldexのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するBeldexクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するBeldexクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されBeldexを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するBeldexクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためBeldexでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Beldexの送金に成功しました</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Beldexのブロックチェーンを初期化しますか？</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ディスク容量節約モードを有効にすると、使用するディスク容量はずっと小さくなりますが、通信帯域の使用量は通常モードと変わりません。ただし、Beldexのネットワークの安全性を高める意味で、完全なブロックチェーンの全体を保存することが推奨されています。もしあなたのコンピュータのディスク容量が小さい場合は、このオプションを使用してください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Beldexの採掘をすることでネットワークの安全性が高まり、また提供した計算量の対価として低い確率ですが報酬が得られます。このオプションは、あなたのコンピュータが電源に接続されていてなおかつアイドル状態の場合に、自動的にBeldexの採掘を行うことを許可します。あなたが作業を再開すると、採掘は停止されます。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Beldexネットワークと通信するためにウォレットはBeldexノードに接続されている必要があります。プライバシーを最大限に保護するため自分自身のノードを走らせることが推奨されています。
...
<context>
    ...
    <message>
        ...
        <translation>Beldexの開発は寄付のみによって支えられています</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをBeldexの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 XMRであった場合、0.0025 XMRが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Beldexを使う</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Beldexへようこそ!</translation>
    </message>
    <message>
...
金額: </translation>
    ...
    <message>
        ...
        <translation>新しいバージョンのBeldex-wallet-guiを入手できます: %1&lt;br&gt;%2</translation>
    </message>
    <message>
...
手数料: </translation>
    ...
    <message>
        ...
        <translation>Beldexの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
