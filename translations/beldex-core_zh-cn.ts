...
<context>
    ...
    <message>
        ...
        <translation>挖矿可增进 Beldex 网络的安全性, 越多使用者的挖矿活动, Beldex 网络就会越难以被攻击. &lt;br&gt; &lt;br&gt;挖矿也让您有机会赚取额外的门罗币, 您的计算机将持续创建哈希值用以寻找区块, 如找到则可以获得该区块所附带的门罗币奖励, 祝您好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">内嵌Beldex版本: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>您在本页面可以操作共享的环签名数据库.  Beldex 钱包以及复制了 Beldex 密钥的克隆钱包都将使用本数据库.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了避免Beldex环签名提供的保护无效, 同一个输出不应该在不同的区块链上使用不同的环签名来支付.  虽然这通常不是一个问题, 但是当复制了 Beldex 密钥的克隆钱包允许您支付到现有输出时, 它可以成为一个问题.  在这种情况下, 您需要确保这些现有输出在两条链上都使用相同的环签名. &lt;br&gt;这将由Beldex和任何不想破坏您隐私权的密钥重用软件自动完成.  &lt;br&gt; 如果您同时在使用复制了 Beldex 密钥的克隆钱包, 并且不包含这种保护, 您仍然可以通过在它之上新的交易来确保您的交易安全, 然后在此页面上手动添加环签名, 从而使您安全地使用Beldex. &lt;br&gt;如果您没有使用无此安全功能的克隆钱包, 那么您不需要做任何事情, 因为所有都是自动的.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的Beldex链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">就快完成了 - Beldex 还需要一点设置</translation>
    </message>
    <message>
        <source>Kickstart the Beldex blockchain?</source>
        <translation type="vanished">开始同步 Beldex 区块链?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>硬盘节约模式能精简区块链的数据而减少硬盘空间的使用量, 但保存完整的区块链能加强 Beldex 网络的安全性, 当您需要在容量较小的硬盘上执行, 那么这个功能就很适合您, 此功能对于网络带宽的用量没有影响. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>启动挖矿功能可让 Beldex 的系统网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>为了能与Beldex网络进行通讯, 您的钱包需要连接上一个Beldex节点. 为了获得最好的隐私, 我们建议您运行一个自己的节点 &lt;br&gt;&lt;br&gt; 如果您无法运行自己的节点, 可以选择连上一个远程的节点. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Beldex的开发完全由捐赠所支持</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>激活自动捐赠给Beldex的开发团队?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一笔交易中 Beldex 系统都会收取小额的手续费, 而这个选项则是让你可以增加额外的金额捐赠 Beldex 的开发, 比例以当次交易的手续费为基础计算, 譬如 50% 的自动捐赠意味着如果转账手续费为 0.005XMR时将会额外捐赠 0.0025 XMR 给 Beldex 开发团队. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Beldex network, and also pays a small reward for the work done. This option will let Beldex mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>启动挖矿功能可让 Beldex 的网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">使用 BELDEX</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">欢迎使用 Beldex！</translation>
    </message>
    <message>
...
环签名大小: </translation>
    ...
    <message>
        ...
        <translation type="vanished">这个地址接收了 %1 beldex，并通过 %2 次的确认。</translation>
    </message>
    <message>
...
Spending address index: </source>
    ...
    <message>
        ...
        <translation>Beldex转账已成功: %1 个交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>This address received %1 beldex, with %2 confirmation(s).</source>
        <translation>这个地址接收了 %1 个beldex, 并通过 %2 次的确认. </translation>
    </message>
    <message>
        <location filename="../main.qml" line="868"/>
        <source>Good signature</source>
...
描述: </translation>
    ...
    <message>
        ...
        <translation>这个地址将收到 %1 个beldex币, 但这笔交易尚未被矿工确认</translation>
    </message>
    <message>
